            ...
            link: function ($scope, $element) {
                ...
                function buildFeedManagerMenu() {
                    ...
                    links.push({
                        ...
                        icon: "folder_special",
                        text: "Categories",
                        permission: AccessConstants.UI_STATES.CATEGORIES.permissions
                    });
                    links.push({
                        sref: "tables",
                        type: 'link',
                        icon: "grid_on",
                        text: "Tables",
                        permission: AccessConstants.UI_STATES.TABLES.permissions
                    });
                    links.push({
                        sref: "service-level-agreements",
                        type: 'link',
                        icon: "beenhere",
                        text: "SLA",
                        permission: AccessConstants.UI_STATES.SERVICE_LEVEL_AGREEMENTS.permissions
                    });
                    links.push({
                        sref: "visual-query",
                        type: 'link',
                        ...
                        text: "Visual Query",
                        fullscreen: true,
                        permission: AccessConstants.UI_STATES.VISUAL_QUERY.permissions
                    });
                ...
                function buildOpsManagerMenu() {
                    ...
                    links.push({
                        sref: "service-health",
                        type: 'link',
                        icon: "vector_triangle",
                        text: "Services",
                        defaultActive: false,
                        permission: AccessConstants.UI_STATES.SERVICE_HEALTH.permissions
                    });
                    links.push({
                        sref: "jobs",
                        type: 'link',
                        ...
                        text: "Jobs",
                        defaultActive: false,
                        permission: AccessConstants.UI_STATES.JOBS.permissions
                    });
                    links.push({
                        sref: "alerts",
                        icon: "notifications",
                        text: "Alerts",
                        defaultActive: false,
                        permission: AccessConstants.UI_STATES.ALERTS.permissions
                    });
                    links.push({
                        sref: "service-level-assessments",
                        type: 'link',
                        icon: "work",
                        text: "SLA Assessments",
                        defaultActive: false,
                        permission: AccessConstants.UI_STATES.SERVICE_LEVEL_ASSESSMENTS.permissions
                    });
                    links.push({
                        sref: "scheduler",
                        type: 'link',
                        ...
                        text: "SLA Schedule",
                        defaultActive: false,
                        permission: AccessConstants.UI_STATES.SCHEDULER.permissions
                    });
                    links.push({
                        sref: "charts",
                        type: 'link',
                        ...
                        text: "Charts",
                        defaultActive: false,
                        permission: AccessConstants.UI_STATES.CHARTS.permissions
                    });
                ...
                function buildAdminMenu() {
                    ...
                    links.push({
                        ...
                        text: "Data Sources",
                        defaultActive: false,
                        permission: AccessControlService.DATASOURCE_ACCESS
                    });
                    links.push({
                        sref: "domain-types",
                        type: "link",
                        ...
                        text: "Domain Types",
                        defaultActive: false,
                        permission: AccessControlService.FEEDS_ADMIN
                    });
                    links.push({
                        sref: "business-metadata",
                        type: 'link',
                        icon: "business",
                        text: "Properties",
                        defaultActive: false,
                        permission: AccessConstants.CATEGORIES_ADMIN
                    });
                    links.push({
                        sref: "registered-templates",
                        type: 'link',
                        icon: "layers",
                        text: "Templates",
                        defaultActive: false,
                        permission: AccessConstants.TEMPLATES_ACCESS
                    });
                    links.push({
                        sref: "users",
                        type: 'link',
                        ...
                        text: "Users",
                        defaultActive: false,
                        permission: AccessConstants.USERS_ACCESS
                    });
                    links.push({
                        sref: "groups",
                        type: 'link',
                        ...
                        text: "Groups",
                        defaultActive: false,
                        permission: AccessConstants.GROUP_ACCESS
                    });
                ...
                function buildExtensionsMenu(rootMenu) {
                    ...
                    additionalKeys = _.filter(additionalKeys, function (key) {
                        return MENU_KEY[key] == undefined
                    });
                ...
                function collapse() {
                    ...
                    angular.element('.site-sidenav').css('overflow', 'hidden')
                    angular.element('.site-sidenav > md-content').css('overflow', 'hidden')
                    angular.element('.site-sidenav').addClass('collapsed');
                    updateMenuText();
                }
                ...
                function expand() {
                    ...
                    angular.element('.site-sidenav').css('overflow', 'auto')
                    angular.element('.site-sidenav > md-content').css('overflow', 'auto')
                    angular.element('.site-sidenav').removeClass('collapsed');
                    updateMenuText();
                }
